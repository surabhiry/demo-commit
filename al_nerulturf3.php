...
<!--            <img class="turf_des" src="turf_des.jpg">-->
            ...
            <h1 style="font-size: 50px;">TRICK SHOT</h1>
        </div>
        
        <div class="turf">
            <img class="turf_img" src="trickshot.JPG">
            <div class="turf_details">
                <h2 style="font-size: 30px;">Trick Shot</h2>
                <p>22G8+M36, Sector 28, Nerul, Navi Mumbai, Maharashtra 400706</p>
                <h3>Contact Details:NA </h3>
                <button><a href="https://kheloforturf-4.youcanbook.me/" target="popup" onclick="window.open('https://kheloforturf-4.youcanbook.me/','popup','resizable=0,width=500,height=500'); return false;">BOOK NOW</a></button>
                <!-- <input type="date" id="start" name="trip-start"
                       value="2021-01-01"
                       min="2021-01-01" max="2030-01-01"> -->
<!--
                <h3>Description:</h3>
                <p>Something about the turf.</p>
-->
                <!-- <select class="select" >
