...
<!--            <img class="turf_des" src="turf_des.jpg">-->
            ...
            <h1 style="font-size: 50px;">GOLDEN GOAL</h1>
        </div>
        
        <div class="turf">
            <img class="turf_img" src="Golden%20goal%202.JPG">
            <div class="turf_details">
                <h2 style="font-size: 30px;">Golden Goal</h2>
                <h3>6X74+XW3, Thane West, Thane, Maharashtra 400606</h3>
                ...
                <button><a href="https://kheloforturf-5-9.youcanbook.me/" target="popup" 
                onclick="window.open('https://kheloforturf-5-9.youcanbook.me/','popup','resizable=0,width=500,height=500'); return false;">BOOK NOW</a></button>
            </div>
        </div>
