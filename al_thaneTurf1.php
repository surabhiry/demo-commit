...
<!--            <img class="turf_des" src="turf_des.jpg">-->
            ...
            <h1 style="font-size: 50px;">HATRICS TURF</h1>
        </div>
        
        <div class="turf">
            <img class="turf_img" src="turf%201.jpg">
            <div class="turf_details">
                <h2 style="font-size: 30px;">Hatrics Turf</h2>
                <p>Resort, Near, Thane(W, Tikuji Ni Wadi Rd, Manpada, Thane, Maharashtra 400607</p>
                <h3>Contact Details: +91 96191 05040</h3>
                ...
                <button><a href="https://kheloforturf-5.youcanbook.me/" target="popup" onclick="window.open('https://kheloforturf-5.youcanbook.me/','popup','resizable=0,width=500,height=500'); return false;">BOOK NOW</a></button>
            </div>
        </div>
