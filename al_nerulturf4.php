...
<!--            <img class="turf_des" src="turf_des.jpg">-->
            ...
            <h1 style="font-size: 50px;">GYMKHANA</h1>
        </div>
        
        <div class="turf">
            <img class="turf_img" src="NerulGymkhana2.jpg">
            <div class="turf_details">
                <h2 style="font-size: 30px;">Gymkhana</h2>
                <p>Plot No 5 & 5A, Seawood Sation Road, Sector No 28, Nerul, Navi Mumbai, Maharashtra 400706</p>
                ...
                <button><a href="https://kheloforturf-8.youcanbook.me/" target="popup" onclick="window.open('https://kheloforturf-8.youcanbook.me/','popup','resizable=0,width=500,height=500'); return false;">BOOK NOW</a></button>
            </div>
        </div>
