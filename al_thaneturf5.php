...
<html>
    <head>
        ...
        <link rel="stylesheet" href="Thane_turf.css">
        <title>Khelo</title>
    </head>
...
<!--            <img class="turf_des" src="turf_des.jpg">-->
            ...
            <h1 style="font-size: 50px;">7 COLORS</h1>
        </div>
        
        <div class="turf">
            <img class="turf_img" src="7%20colors%202.JPG">
            <div class="turf_details">
                <h2 style="font-size: 30px;">7 Colors</h2>
                <p>Unnathi Woods Rd, Kasarvadavali, Thane West, Thane, Maharashtra 400615</p>
                ...
                <button><a href="https://kheloforturf-5-4.youcanbook.me/" target="popup" 
                onclick="window.open('https://kheloforturf-5-4.youcanbook.me/','popup','resizable=0,width=500,height=500'); return false;">BOOK NOW</a></button>
            
             <!-- <a href="https://kheloforturf.youcanbook.me/" data-ycbm-modal="true"><img src="https://youcanbook.me/resources/pics/ycbm-button.png" style="border-style:none;"/>Book  -->
            </a>
            </div>
        </div>
