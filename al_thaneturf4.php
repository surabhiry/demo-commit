...
<!--            <img class="turf_des" src="turf_des.jpg">-->
            ...
            <h1 style="font-size: 50px;">TURF TMC</h1>
        </div>
        
        <div class="turf">
            <img class="turf_img" src="tmc.jpg">
            <div class="turf_details">
                <h2 style="font-size: 30px;">Turf TMC</h2>
                <p>TMC TurfPark, Gawand Baug, Near Venus CHS, Thane West, Thane, Maharashtra 400610</p>
                <h3>Contact Details: 070456 46463 </h3>
                ...
                <button><a href="https://kheloforturf-5-6.youcanbook.me/" target="popup"
                 onclick="window.open('https://kheloforturf-5-6.youcanbook.me/','popup','resizable=0,width=500,height=500'); return false;">BOOK NOW</a></button>
            </div>
        </div>
