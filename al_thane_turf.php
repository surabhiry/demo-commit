    ...
    <div class="turfs">
        <div class="card">
            ...
            <div class="details">
                ...
                <p class="price">INR 1,700.00</p>
                <p>Thane</p>
                <a href="http://localhost/Brackets/al_thaneturf1.php"><p><button>Book Now</button></p></a>
            </div> 
        </div>
        
        <div class="card">
            <img alt="" src="Golden%20goal%202.JPG" >
            <div class="details">
                <h2 style="font-size: 16px;">Golden Turf</h2>
                <p class="price">INR 1,500.00</p>
                <p>Thane</p>
                <a href="http://localhost/Brackets/al_thaneturf2.php"><p><button>Book Now</button></p></a>
            </div> 
        </div>
        ...
        <div class="card">
            ...
            <div class="details">
                ...
                <p class="price">INR 1,500.00</p>
                <p>Thane</p>
                <a href="http://localhost/Brackets/al_thaneturf3.php"><p><button>Book Now</button></p></a>
            </div> 
        </div>
        ...
        <div class="card">
            ...
            <div class="details">
                ...
                <p class="price">INR 1,500.00</p>
                <p>Thane</p>
                <a href="http://localhost/Brackets/al_thaneturf4.php"><p><button>Book Now</button></p></a>
            </div> 
        </div>
        ...
        <div class="card">
            ...
            <div class="details">
                ...
                <p class="price">INR 1,500.00</p>
                <p>Thane</p>
                <a href="http://localhost/Brackets/al_thaneturf5.php"><p><button>Book Now</button></p></a>
            </div> 
        </div>
    </div>
