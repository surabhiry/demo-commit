...
<!--            <img class="turf_des" src="turf_des.jpg">-->
            ...
            <h1 style="font-size: 50px;">URBAN TURF</h1>
        </div>
        
        <div class="turf">
            <img class="turf_img" src="urban.jpg">
            <div class="turf_details">
                <h2 style="font-size: 30px;">Urban Turf</h2>
                <p>Kavesar, anand nagar, Kasarvadavali, Thane West, Thane, Maharashtra 400615</p>
                <h3>Contact Details: 09969985000</h3>
                ...
                <button><a href="https://kheloforturf-5-04.youcanbook.me/" target="popup" 
                onclick="window.open('https://kheloforturf-5-04.youcanbook.me/','popup','resizable=0,width=500,height=500'); return false;">BOOK NOW</a></button>
            </div>
        </div>
